---
title: "ReMoTe simulation: No mixing, no Ackley"
author: ""
...
```{r}
pars <- read.xlsx("G:/My Drive/Work/TB Projects/ReMoTe local/Parameters/Pars_2021_11_5.xlsx",sheetName = "No Mixing, No Ackley")
prevs <- pars[,1]
low.prev <- pars[1,3]
...
save(num.inf.age,num.inf.nomix,print.nomix,file="./Output/noMix_noackley_plotData.RData")
```
